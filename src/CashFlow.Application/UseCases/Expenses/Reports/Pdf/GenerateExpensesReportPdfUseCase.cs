...
using CashFlow.Domain.Entity.Extensions;
...
public class GenerateExpensesReportPdfUseCase : IGenerateExpensesReportPdfUseCase
{
    ...
    public async Task<byte[]> Execute(DateOnly month)
    {
        ...
        foreach (var expense in expenses)
        {
            ...
            SetStyleBaseForExpenseInfortion(row.Cells[0]);
            row.Cells[0].Format.LeftIndent = 20;
            
            row.Cells[1].AddParagraph(expense.Date.ToString("t"));
            SetStyleBaseForExpenseInfortion(row.Cells[1]);
            
            row.Cells[2].AddParagraph(expense.PaymentType.PaymentToString());
            SetStyleBaseForExpenseInfortion(row.Cells[2]);
    ...
    private Document CreateDocument(DateOnly month)
    {
        ...
        document.Info.Title = $"{ResourceReportGenerationMessages.EXPENSE_FOR} {month.ToString("Y")}";
        document.Info.Author = "João Naif";
    ...
    private void CreateHeaderWithProfilePhotoAndName(Section page)
    {
        ...
        var pathFile = Path.Combine(directoryName!, "Logo", "logoCash.jpg");
        
        row.Cells[0].AddImage(pathFile);
        
        row.Cells[1].AddParagraph("Hey, João Naif");
    ...
    private void SetStyleBaseForExpenseInfortion(Cell cell)
    {
        cell.Format.Font = new Font
