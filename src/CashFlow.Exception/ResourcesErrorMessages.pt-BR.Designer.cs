...
namespace CashFlow.Exception {
    ...
    public class ResourcesErrorMessages_pt_BR {
        ...
        internal static string EXMPENSES_CANNOT_FOR_THE_FUTURE {
            get {
                return ResourceManager.GetString("EXMPENSES_CANNOT_FOR_THE_FUTURE", resourceCulture);
            }
        }
